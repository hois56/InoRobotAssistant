...
assert.match(main, /new WebSocket\(bridge\.socketUrl\)/);
...
console.log('Virtual controller validation passed: strict joint-only Trace input and direct joint updates.');
