...
assert.match(source, /snapTriangleBudget: 25000/);
...
assert.match(source, /const workerBuffer = buffer\.slice\(0\)/);
assert.match(source, /worker\.postMessage\([\s\S]*buffer:\s*workerBuffer[\s\S]*\}, \[workerBuffer\]\)/);
